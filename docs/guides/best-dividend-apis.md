...
| [Alpha Vantage](https://www.alphavantage.co/documentation/#dividends)（QVeris）· [Try it in QVeris](https://qveris.ai/providers/alphavantage) | **本次样本通过**：AAPL 正向样本与无效 symbol 控制均连续三轮满足门槛 | 576 ms / 2 credits/call | Premium USD 49.99/月起；免费层 25 次/日 | 4 个适用市场通过（2/2）；5 个未测试：明确不适用 |
